...
from homework_10 import check_age_more_than_30
from hillel_2510_olga.lesson_10.core.function_asserts import assert_true
...
class TestCheckAgeNegativeScenariouse:
